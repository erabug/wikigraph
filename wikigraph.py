...
import query, sqlite3, random, time, os

app = Flask(__name__)
app.secret_key = os.environ.get('FLASK_SECRET_KEY', 'lisaneedsbraces')
...
def get_random_names():
    ...
    print "Requesting two random pages..."
    t0 = time.time()
    ...
    t1 = time.time()
    print "DB responded in %0.2f seconds" % (t1 - t0)
